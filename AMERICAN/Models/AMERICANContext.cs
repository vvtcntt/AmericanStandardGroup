...
using AMERICAN.Models.Mapping;

namespace AMERICAN.Models
{
    public partial class AMERICANContext : DbContext
    {
        static AMERICANContext()
        {
            Database.SetInitializer<AMERICANContext>(null);
        }

        public AMERICANContext()
            : base("Name=AMERICANContext")
        {
        }
