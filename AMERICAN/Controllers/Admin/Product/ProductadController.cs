...
using System.IO;
using System.Xml;
namespace AMERICAN.Controllers.Admin.Productad
{
    public class ProductadController : Controller
    {
        ...
        public PartialViewResult PartialProductData(int? page, string text, string idCate)
        {
            string txtSearch = "";
            ...
            if (Request.IsAjaxRequest())
            {
                ...
                if (idCate != null && idCate != "")
                {
                    ...
                    ViewBag.idcate = idCate; ViewBag.idcate = idCate;
                    return PartialView(listProduct.ToPagedList(pageNumber, pageSize));
                }
                if (text != null && text != "" && idCate != null && idCate != "")
                {
                    idCatelogy = int.Parse(idCate);
                    ViewBag.idMenu = idCate; ViewBag.idcate = idCate;
